          ...
          <div class="author">
            ...
            <div class="info">
              ...
              <div class="meta">
                ...
                <span class="wordage">
                  Word count {{state.articleDetail.numbers}}
                </span>
                <span class="views-count">
                  Read {{state.articleDetail.meta.views}}
                </span>
                <span class="comments-count">
                  Comment {{state.articleDetail.meta.comments}}
                </span>
                <span class="likes-count">
                  Like {{state.articleDetail.meta.likes}}
                </span>
              </div>
            </div>
            <div
...
export default defineComponent({
  ...
  setup() {
    const state = reactive({
      ...
      params: {
        id: "",
        type: 1, //Article Type => 1: General Article, 2: Resume, 3: Admin Introduction
    ...
    const likeArticle = async (): Promise<void> => {
      ...
      if (state.likeTimes > 0) {
        ElMessage({
          message: "You have already liked! Take it easy!",
          type: "warning",
        });
        return;
      }
      ...
      if (window.sessionStorage.userInfo) {
        ...
        ElMessage({
          message: "Login to like, please login first!",
          type: "warning",
        });
        return;
      }
    ...
    const handleAddComment = async (): Promise<void> => {
      ...
      if (nowTime - state.cacheTime < 4000) {
        ElMessage({
          message: "You are commenting too frequently, please leave a message in 1 minute!",
          type: "warning",
        });
        return;
      }
  ...
  beforeUnmount(): void {
    document.title = "night and day's blog site";
    document
      .getElementById("keywords")
      .setAttribute("content", "The blog site of the night");
    document
      .getElementById("description")
      .setAttribute(
        "content",
        "Share technical articles related to big front-end development, hot resources, and the growth path of full-stack programmers"
      );
  },
});
</script>
